    ...
    private static IReadOnlyList<FightPlayerIndexDto> BuildPlayersFromAnalystPayload(IReadOnlyList<WvWAnalystPlayerSummaryDto>? players)
    {
        ...
        return players
            ...
            .Select(player => new FightPlayerIndexDto(
                ...
                DamageToDownedTargets: player.DamageToDownedTargets,
                Downs: player.Downs,
                Kills: player.Kills,
                DownContribution: player.DownContribution,
                ...
                DownedHealing: player.DownedHealing,
                Barrier: player.Barrier,
                Resurrects: player.Resurrects,
                IllusionOfLifeRezzes: player.IllusionOfLifeRezzes,
                Deaths: player.Deaths,
                Recoveries: player.Recoveries,
                DamageTaken: player.DamageTaken,
                PetDamageAbsorbed: player.PetDamageAbsorbed,
                DamageReflectedOnEnemy: player.DamageReflectedOnEnemy,
                MysticRebukeDamage: player.MysticRebukeDamage,
                Pulls: player.Pulls,
